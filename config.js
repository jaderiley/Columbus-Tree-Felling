...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Columbus Tree Felling",
    phone:     "078 600 6367",
    whatsapp:  "078 600 6367",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Columbus Tree Felling — Tree felling in kempton park",
    description: "Columbus Tree Felling provides professional tree felling in Kempton Park. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Tree felling · Kempton Park & surrounds",
    heroTitle:  "Safe tree felling — <em>from assessment to clean-up.</em>",
    heroLead:   "Columbus Tree Felling handles tree felling, stump removal and trimming across Kempton Park and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "Columbus Tree Felling team at work in Kempton Park",
      text:  "Safe, efficient tree felling — from assessment to clean-up."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Kempton Park. Covering the wider area.",
    areasLead:  "We work across Kempton Park, Edenvale, Benoni and the surrounding suburbs. Emergency callouts for storm damage handled as quickly as possible.",
